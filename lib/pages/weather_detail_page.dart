      ...
      body: _weather?.cityName == null
          ...
          : Center(
              child: Column(
                ...
                children: [
                  Text(
                    _weatherRA?.cityName ?? "Loading city...",
                    style: TextStyle(
                      fontSize: 55, // Tamaño de fuente deseado
                  ...
                  Lottie.asset(getWeatherAnimation(_weatherRA?.mainCondition)),
                  Text(
                    '${_weatherRA?.temperature.round()}°C',
                    style: TextStyle(
                      fontSize: 32, // Tamaño de fuente deseado
                      // Otros estilos de texto si es necesario
                    ),
